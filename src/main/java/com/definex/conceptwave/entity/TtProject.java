...
public class TtProject {
    ...
    public TtProject(String devCampMailCount, Date finishPeriod, int hasAddedStatus, String headOfSales, String headOfSalesMail, String headOfTechnicalSales, String headOfTechnicalSalesMail, String ipVpnSubscriptionId, String ipVpnId, int isSignalSent, int isTresholdReached, int manuallyBilledApCount, int numberOfAp, int numberOfApAtRfb, int numberOfSubmittedAp, int portalRequestNumber, String projectCode, Date projectFirstRelationDate, String projectManager, String projectManagerEmail, String projectManagerId, String projectName, int projectStatus, String relatedWithDecCamp, String salesManager, String salesManagerEmail, String serviceType, String technicalSalesManager, String technicalSalesManagerEmail, String tresholdPercentage, String turnKeyCode, int turnKeyDateStatus, Date turnKeyDeliveryDate, int turnKeyStatus) {
